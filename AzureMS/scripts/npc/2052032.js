...
var xitemcode = 4001911, xqty = 1;

var list = [
{'item' : 1022226, 'chance' : 800},
{'item' : 1022123, 'chance' : 500},
{'item' : 1162013, 'chance' : 400},
{'item' : 1112675, 'chance' : 200},
//{'item' : 2048094, 'chance' : 500},
//{'item' : 2048095, 'chance' : 1000}
]
...
var minAllStat = 70, maxAllStat = 550;
var minAtt = 60, maxAtt = 500;
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		var msg = "#fs11##dGood Morning, #rAzure Orbs#k #dExchange system.\r\nThe #rOmni-CLN Orb#k #dYou can get items with it.\r\nBoss Ornament Options Informations :\r\n - #rAll Stats 70 ~ 550 / ATT, M.ATT 60 ~ 500#k#fs11#"+enter;
