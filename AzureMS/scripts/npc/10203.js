...
var sMin = 100; //Zero box stat minimum

var sMax = 200; //0 box stat highest

var sMin2 = 50; //0st box minimum casting level

var sMax2 = 200; //0st box high

 

var ssMin = 100; //No. 1 box stat
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var text = "#fs11##dHello Oz Planet #rTyrant Random Exchange Shop#k #d¿‘¥œ¥Ÿ#k\r\n\r\n#rTyrant#k Max Min Number Ball, Do : #r50 ~ 200#k  All Stat : #r100 ~ 200#k\r\n#d\r\n\r\n"

        text += "#L0##dReplace the Silent Cloak #r(Cloak)#k    #i1102481# #l\r\n"

        text += "#L1##dI change the talent gloves #r(Gloves)#k   #i1082543# #l\r\n"

        text += "#L2##dWe change fluent shoes #r(Shoes)#k    #i1072743# #l\r\n"

        text += "#L3##dWe change silent belt #r(Belt)#k   #i1132174# #l\r\n"

        //text += "#i1052887##L4#      We change Absolab suit.#l\r\n"

        //text += "#i1073030##L5#      Exchange Absolabs Shoes.#l\r\n"
		...
		cm.gainItemAllStat(itemid, 1, astat, wmatk);
                ...
                text += "#fs11##i" + itemcode + "# #b#t" + itemcode + "##kCame out."
		...
		cm.gainItemAllStat(itemid, 1, astat, wmatk);
                ...
                text += "#fs11##i" + itemcode1 + "# #b#t" + itemcode1 + "##kCame out."
		...
		cm.gainItemAllStat(itemid, 1, astat, wmatk);
                ...
                text += "#fs11##i" + itemcode2 + "# #b#t" + itemcode2 + "##k Came out."
		...
		cm.gainItemAllStat(itemid, 1, astat, wmatk);
                ...
                text += "#fs11##i" + itemcode3 + "# #b#t" + itemcode3 + "##k Came out."
		...
		cm.gainItemAllStat(itemid, 1, astat, wmatk);
                ...
                text += "#fs11##i" + itemcode4 + "# #b#t" + itemcode4 + "##k Came out."
