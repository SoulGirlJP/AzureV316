...
var xitemcode = 4001919, xqty = 1;

var list = [
//{'item' : 4001879, 'chance' : 7000},
//{'item' : 4310218, 'chance' : 7000},
//{'item' : 2439614, 'chance' : 200},
{'item' : 1190302, 'chance' : 50},
{'item' : 1182006, 'chance' : 50},
{'item' : 1162083, 'chance' : 100},
{'item' : 2591640, 'chance' : 100}
...
var minAllStat = 700, maxAllStat = 2200;
var minAtt = 650, maxAtt = 2150;
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		var msg = "#fs11##dGood Morning, #rAzure Orbs#k #dExchange system.\r\nThe #rWill Orb#k #dYou can get items with it.\r\nBoss Ornament Options Informations :\r\n - #rAll Stats 700 ~ 2200 / ATT, M.ATT 650 ~ 2150#k#fs11#"+enter;
