...
var xitemcode = 4001905, xqty = 1;

var list = [
//{'item' : 2433019, 'chance' : 1000},
{'item' : 1102601, 'chance' : 1000}, 
{'item' : 1182010, 'chance' : 500},
{'item' : 1113064, 'chance' : 500}
...
var minAllStat = 1, maxAllStat = 100;
var minAtt = 1, maxAtt = 75;
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		var msg = "#fs11##dGood Morning, #rAzure Orbs#k #dExchange system.\r\nThe #rFire Wolf Orb#k #dYou can get items with it.\r\nBoss Ornament Options Informations :\r\n - #rAll Stats 1 ~ 100 / ATT, M.ATT 1 ~ 75#k#fs11#"+enter;
