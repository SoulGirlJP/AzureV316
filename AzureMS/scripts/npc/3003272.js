...
var xitemcode = 4001915, xqty = 1;

var list = [
{'item' : 4001879, 'chance' : 4000},
//{'item' : 4310218, 'chance' : 7000},
//{'item' : 2439614, 'chance' : 700},
{'item' : 1132308, 'chance' : 100},
{'item' : 1662111, 'chance' : 100},
{'item' : 2591590, 'chance' : 150},
...
var minAllStat = 300, maxAllStat = 1400;
var minAtt = 290, maxAtt = 1350;
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		var msg = "#fs11##dGood Morning, #rAzure Orbs#k #dExchange system.\r\nThe #rLucid Orb#k #dYou can get items with it.\r\nBoss Ornament Options Informations :\r\n - #rAll Stats 300 ~ 1400 / ATT, M.ATT 290 ~ 1350#k#fs11#"+enter;
