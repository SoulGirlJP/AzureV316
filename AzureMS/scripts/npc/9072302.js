...
var xitemcode = 4001903, xqty = 1;

var list = [
{'item' : 1032216, 'chance' : 300},
{'item' : 1022144, 'chance' : 250},
{'item' : 2591087, 'chance' : 300}
]
...
var minAllStat = 80, maxAllStat = 700;
var minAtt = 70, maxAtt = 650;
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		var msg = "#fs11##dGood Morning, #rAzure Orbs#k #dExchange system.\r\nThe #rPink-Bean Orb#k #dYou can get items with it.\r\nBoss Ornament Options Informations :\r\n - #rAll Stats 80 ~ 700 / ATT, M.ATT 70 ~ 650#k#fs11#"+enter;
