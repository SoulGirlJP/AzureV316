...
chat += "\r\n\r\n#L998##r#i4031456#  #e#r2#k#n(개)#L5# #i2450010##r1개#k#n";

chat += "\r\n\r\n#L998##r#i4031456#  #e#r6#k#n(개)#L6# #i2450010##r3개#k#n";

chat += "\r\n\r\n#L998##r#i4031456#  #e#r10#k#n(개)#L7# #i2450010##r5개#k#n";

chat += "\r\n\r\n#L998##r#i4031456#  #e#r20#k#n(개)#L8# #i2450010##r10개#k#n";
	       cm.sendSimple(chat);

	    }  if (selection >= 9999999) {
		    cm.dispose();
} else if (selection == 5) {
if (cm.haveItem(4031456, 2)) {
		    if (cm.canHold(4031456)) {
		        cm.sendOk("#r낚시 구슬로#k #i2450010##r1개#k#n 를 구입 하셨습니다.");
...
if (cm.haveItem(4031456, 6)) {
		    if (cm.canHold(4031456)) {
		        cm.sendOk("#r낚시 구슬로#k #i2450010##r3개#k#n  를 구입 하셨습니다.");
			cm.gainItem(4031456, -6);
                                           cm.gainItem(2450010, 3);
			cm.dispose();
		    } else {
		        cm.sendOk("소비창에 빈 공간이 없습니다.");
		        cm.dispose();
...
if (cm.haveItem(4031456, 10)) {
		    if (cm.canHold(4031456)) {
		        cm.sendOk("#r낚시 구슬로#k #i2450010##r5개#k#n 를 구입 하셨습니다.");
			cm.gainItem(4031456, -10);
                                              cm.gainItem(2450010, 5);
			cm.dispose();
		    } else {
		        cm.sendOk("소비창에 빈 공간이 없습니다.");
		        cm.dispose();
...
if (cm.haveItem(4031456, 20)) {
		    if (cm.canHold(4031456)) {
		        cm.sendOk("#r낚시 구슬로#k#i2450010##r10개#k#n 를 구입 하셨습니다.");
			cm.gainItem(4031456, -20);
                                       cm.gainItem(2450010, 10);
			cm.dispose();
		    } else {
		        cm.sendOk("소비창에 빈 공간이 없습니다.");
		        cm.dispose();
