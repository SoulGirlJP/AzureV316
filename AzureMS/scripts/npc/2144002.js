...
var xitemcode = 4001916, xqty = 1;

var list = [
//{'item' : 4310156, 'chance' : 5000}, 1152156
{'item' : 1152156, 'chance' : 150}
...
var minAllStat = 500, maxAllStat = 1800;
var minAtt = 490, maxAtt = 1750;
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		var msg = "#fs11##dGood Morning, #rAzure Orbs#k #dExchange system.\r\nThe #rCross Orb#k #dYou can get items with it.\r\nBoss Ornament Options Informations :\r\n - #rAll Stats 500 ~ 1800 / ATT, M.ATT 490 ~ 1750#k#fs11#"+enter;
