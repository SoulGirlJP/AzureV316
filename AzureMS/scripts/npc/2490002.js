...
var xitemcode = 4001907, xqty = 1;

var list = [
//{'item' : 2433019, 'chance' : 1000},
{'item' : 1122150, 'chance' : 800},
{'item' : 1113070, 'chance' : 500},
//{'item' : 2046856, 'chance' : 500},
//{'item' : 2046857, 'chance' : 500},
{'item' : 2591202, 'chance' : 300}
]
...
var minAllStat = 40, maxAllStat = 250;
var minAtt = 30, maxAtt = 225;
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		var msg = "#fs11##dGood Morning, #rAzure Orbs#k #dExchange system.\r\nThe #rArkarium Orb#k #dYou can get items with it.\r\nBoss Ornament Options Informations :\r\n - #rAll Stats 40 ~ 250 / ATT, M.ATT 30 ~ 225#k#fs11#"+enter;
