...
chat += "\r\n\r\n#L998##r#i4031456#  #e#r1#k#n(개)#L5# #i2435458##r100개#k#n";

chat += "\r\n\r\n#L998##r#i4031456#  #e#r3#k#n(개)#L6# #i2435458##r300개#k#n";

chat += "\r\n\r\n#L998##r#i4031456#  #e#r5#k#n(개)#L7# #i2435458##r500개#k#n";

chat += "\r\n\r\n#L998##r#i4031456#  #e#r10#k#n(개)#L8# #i2435458##r1000개#k#n";
	       cm.sendSimple(chat);
...
if (cm.haveItem(4031456, 1)) {
		    if (cm.canHold(4031456)) {
		        cm.sendOk("#r낚시 구슬로#k #i2435458##r100개#k#n 를 구입 하셨습니다.");
			cm.gainItem(4031456, -1);
                                           cm.gainItem(2435458, 100);
			cm.dispose();
		    } else {
...
if (cm.haveItem(4031456, 3)) {
		    if (cm.canHold(4031456)) {
		        cm.sendOk("#r낚시 구슬로#k #i2435458##r300개#k#n  를 구입 하셨습니다.");
			cm.gainItem(4031456, -3);
                                           cm.gainItem(2435458, 300);
			cm.dispose();
		    } else {
		        cm.sendOk("소비창에 빈 공간이 없습니다.");
		        cm.dispose();
...
if (cm.haveItem(4031456, 5)) {
		    if (cm.canHold(4031456)) {
		        cm.sendOk("#r낚시 구슬로#k #i2435458##r500개#k#n 를 구입 하셨습니다.");
			cm.gainItem(4031456, -5);
                                              cm.gainItem(2435458, 500);
			cm.dispose();
		    } else {
		        cm.sendOk("소비창에 빈 공간이 없습니다.");
		        cm.dispose();
...
if (cm.haveItem(4031456, 10)) {
		    if (cm.canHold(4031456)) {
		        cm.sendOk("#r낚시 구슬로#k#i2435458##r1000개#k#n 를 구입 하셨습니다.");
			cm.gainItem(4031456, -10);
                                       cm.gainItem(2435458, 1000);
			cm.dispose();
		    } else {
		        cm.sendOk("소비창에 빈 공간이 없습니다.");
		        cm.dispose();
