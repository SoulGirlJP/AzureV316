...
var xitemcode = 4001922, xqty = 1;

var list = [
{'item' : 2434587, 'chance' : 600}
...
var minAllStat = 1, maxAllStat = 1100;
var minAtt = 1, maxAtt = 1050;
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		var msg = "#fs11##dGood Morning, #rAzure Orbs#k #dExchange system.\r\nThe #rVellum Orb#k #dYou can get items with it.\r\nBoss Ornament Options Informations :\r\n - #rAll Stats 1 ~ 1100 / ATT, M.ATT 1 ~ 1050#k#fs11#"+enter;
