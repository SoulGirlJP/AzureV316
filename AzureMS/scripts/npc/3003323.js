...
var bossid = 9300890; // 보스 몹 코드
var secondboss = 9999991; // (루시드, 스우만 적용. 2페 몹)
var startmap = 500000009; // 보스 맵
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		var msg = "#fUI/UIWindow2.img/MobGage/Mob/9300890# :: #r데미안#k>#d"+enter;
                msg += "<보스 보상 : #i4032101##fs14##r100개#r#fs11# >"+enter;
