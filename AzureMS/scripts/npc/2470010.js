...
var xitemcode = 4001904, xqty = 1;

var list = [
//{'item' : 4310156, 'chance' : 5000},
//{'item' : 4310199, 'chance' : 5000},
{'item' : 1022277, 'chance' : 50}
//{'item' : 2046991, 'chance' : 500},
//{'item' : 2046992, 'chance' : 500},
//{'item' : 4001431, 'chance' : 5000},
...
var minAllStat = 600, maxAllStat = 2000;
var minAtt = 590, maxAtt = 1950;
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		var msg = "#fs11##dGood Morning, #rAzure Orbs#k #dExchange system.\r\nThe #rPapulatus Orb#k #dYou can get items with it.\r\nBoss Ornament Options Informations :\r\n - #rAll Stats 600 ~ 2000 / ATT, M.ATT 590 ~ 1950#k#fs11#"+enter;
