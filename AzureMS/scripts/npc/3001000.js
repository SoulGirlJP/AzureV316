...
var xitemcode = 4001901, xqty = 1;

var list = [
//{'item' : 2433019, 'chance' : 1000},
//{'item' : 1152170, 'chance' : 300},1152170
{'item' : 1152170, 'chance' : 800},
{'item' : 1182087, 'chance' : 500},
{'item' : 2433453, 'chance' : 350},
//{'item' : 1402180, 'chance' : 300},
{'item' : 2591264, 'chance' : 300}
//{'item' : 4001431, 'chance' : 1000}
]
...
var minAllStat = 60, maxAllStat = 400;
var minAtt = 50, maxAtt = 375;
...
function action(mode, type, sel) {
	...
	if (status == 0) {
		...
		var msg = "#fs11##dGood Morning, #rAzure Orbs#k #dExchange system.\r\nThe #rMagnus Orb#k #dYou can get items with it.\r\nBoss Ornament Options Informations :\r\n - #rAll Stats 60 ~ 400 / ATT, M.ATT 50 ~ 375#k#fs11#"+enter;
