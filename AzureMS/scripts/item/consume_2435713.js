...
var ssMin = 300; //No. 1 box stat

var ssMax = 1400; //No. 1 box stat high

var ssMin2 = 290; //Box No. 1

var ssMax2 = 1350; //Box 1 highest horse run

 

var sssMin = 300; //No. 2 box stat

var sssMax = 1400; //Box No. 2 stat highest

var sssMin2 = 290; //Minimum number of box 2 casting

var sssMax2 = 1350; //Box 2 highest

 

var ssssMin = 300; //No. 3 box stat

var ssssMax = 1400; //Box 3 stat high

var ssssMin2 = 290; //3 box minimum casting

var ssssMax2 = 1350; //Box 3 highest
...
var randomcode = new Array(1102940,1102941,1102942,1102943,1102944);
...
var box = 2435713; //Box code in description
...
var randomcode1 = new Array(1082695,1082696,1082697,1082698,1082699);
...
var req1 = 4001895; //Need

var reqcount1 = 5; //Required number

 

var box1 = 2435713; //Box code in description
...
var randomcode2 = new Array(1073158,1073159,1073160,1073161,1073162);
...
var req2 = 4001895; //Need

var reqcount2 = 5; //Required number

 

var box2 = 2435713; //Box code in description
...
var randomcode3 = new Array(1053063,1053064,1053065,1053066,1053067);
...
var req3 = 4001895; //Need

var reqcount3 = 5; //Required number

 

var box3 = 2435713; //Box code in description
...
var randomcode4 = new Array(1004808,1004809,1004810,1004811,1004812);
...
var req4 = 4001895; //Need

var reqcount4 = 5; //Required number

 

var box4 = 2435713; //Box code in description



// Box 5

var randomcode5 = new Array(1152196,1152197,1152198,1152199,1152200);
...
var req5 = 4001895; //Need

var reqcount5 = 5; //Required number

 

var box5 = 2435713; //Box code in description
...
function action(mode, type, selection) { 
    ...
    if (status == 0) {
        ...
        var text = "#fs11##dGood morning Azure #rArcane Random Exchange Shop#k #dis#k\r\n\r\n#r Arcane Option Ornament :#k\r\n- All Stats 300 ~ 1400 / ATT, M.ATT 290 ~ 1350#k\r\n#d\r\n\r\n"

        text += "#L0##dArcane Cloak #r(Cloak)#k    #i1102775# #l\r\n"

        text += "#L1##dArcane Gloves #r(Gloves)#k   #i1082639# #l\r\n"

        text += "#L2##dArcane Shoes #r(Shoes)#k    #i1073035# #l\r\n"

        text += "#L3##dArcane Tops #r(Tops)#k   #i1052888# #l\r\n"

        text += "#L4##dArcane Hat #r(Hats)#k   #i1004424# #l\r\n"

        text += "#L5##dArcane Shoulders #r(Shoulders)#k   #i1152176# #l\r\n"
