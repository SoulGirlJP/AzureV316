...
var sMin = 200; //Zero box stat minimum

var sMax = 1200; //0 box stat highest

var sMin2 = 190; //0st box minimum casting level

var sMax2 = 1150; //0th Box Highest Horse Run

 

var ssMin = 200; //No. 1 box stat

var ssMax = 1200; //No. 1 box stat high

var ssMin2 = 190; //Box No. 1

var ssMax2 = 1150; //Box 1 highest horse run

 

var sssMin = 200; //No. 2 box stat

var sssMax = 1200; //Box No. 2 stat highest

var sssMin2 = 190; //Minimum number of box 2 casting

var sssMax2 = 1150; //Box 2 highest

 

var ssssMin = 200; //No. 3 box stat

var ssssMax = 1200; //Box 3 stat high

var ssssMin2 = 190; //3 box minimum casting

var ssssMax2 = 1150; //Box 3 highest
...
var box = 4310156; //Box code in description
...
var box1 = 4310156; //Box code in description
...
var box2 = 4310156; //Box code in description
...
var box3 = 4310156; //Box code in description
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var text = "#fs11##dGood morning Azure #rAbsolab Random Exchange Shop#k #dis#k\r\n\r\n#r Absolab Option Ornament :#k\r\n- All Stats 1 ~ 1400 / ATT, M.ATT 1 ~ 1350#k\r\n#d\r\n\r\n"
